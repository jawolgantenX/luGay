#!/usr/bin/python
#encoding=utf-8
#Belajarlah Bahasa Pemerograman Dari Pada COPET (COPY PASTE EDIT) SCRIPT ORANG AJG
...
def opening():
	os.system("clear")
	print("\t\t     Tools CRACKING v99 :)\nAuthor : jawolgantenX | YT : mr j29 | WA : +6282241006291\n\n[01]. Login Access Token Fb\n[02]. Cara Mendapatkan Access Token Fb\n[00]. Keluar\n")
	kintil()
def login():
